...
func newRepository(
	...
	// headers (tag and digest) to all requests during push/pull. This implementation assumes the repository instance
	// returned by this function is used for a single push/pull at a time (not in parallel)
